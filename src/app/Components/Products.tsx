...
const Product = () => {
  ...
  const navigateToProducts = () => {
    router.push('/productlisting'); // Redirects to the "/productlisting" page
  };
      ...
      <section>
        <div className="px-8 py-12 text-[#2A254B] mt-12">
          ...
          <div className="my-10 flex justify-center items-center">
            <button className="bg-[#F9F9F9] py-4 px-6 rounded-[5px] text-[#2A254B]" onClick={navigateToProducts}>
              View Products
            </button>
          </div>
        </div>
